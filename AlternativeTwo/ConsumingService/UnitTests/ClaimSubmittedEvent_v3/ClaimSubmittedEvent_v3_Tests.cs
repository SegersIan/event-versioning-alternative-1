...
namespace ConsumingService.UnitTests.ClaimSubmittedEvent_v3
{
    [TestClass]
    public class ClaimSubmittedEvent_v3_Tests
    {
        private static readonly string EVENT_VERSION = "v3";
        ...
        public void CANREAD_V1_EVENT()
        {
            ...
            Assert.AreEqual(ClaimType.Unknown, claimSubmittedEvent.ClaimType);
        }
        ...
        public void CANREAD_V3_EVENT()
        {
            ...
            Assert.AreEqual(DateTime.Parse(SUBMISSION_DATE), claimSubmittedEvent.SubmittedOn);
            Assert.AreEqual("Ian", claimSubmittedEvent.SubmittedBy);
            Assert.AreEqual(ClaimType.Property, claimSubmittedEvent.ClaimType);
        }
